...
def _macos_application_impl(ctx):
    ...
    processor_partials = [
        ...
        partials.apple_symbols_file_partial(
            actions = actions,
            binary_artifact = binary_artifact,
            dependency_targets = embedded_targets + ctx.attr.deps,
            dsym_binaries = debug_outputs.dsym_binaries,
            label_name = label.name,
...
macos_dynamic_framework = rule_factory.create_apple_bundling_rule(
    ...
    platform_type = "macos",
    product_type = apple_product_type.framework,
    doc = "Builds and bundles an macOS dynamic framework that is consumable by Xcode.",
)
...
macos_static_framework = rule_factory.create_apple_bundling_rule(
    ...
    doc = """Builds and bundles an macOS static framework for third-party distribution.
